...
const ClassSched = ({ courseCode,  day, time, room }: ClassSchedProps) => {
  return (
    <div className='bg-pink-300 h-[11rem] w-[13rem] flex flex-col text-nowrap overflow-hidden 
        px-[1rem] py-4 gap-2 rounded-md'>
        <h1 className="font-bold">{courseCode}</h1>
        <hr className='bg-slate-700 h-[.2rem] w-[100%] border-none rounded-lg self-start'/>
