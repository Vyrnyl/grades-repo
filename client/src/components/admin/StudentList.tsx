            ...
            <div className="bg-blu-200 h-[80%] mb-[1rem] overflow-y-scroll">
                <table className="w-full font-semibold text-white">
                    <thead className="bg-blue-500 sticky top-0 z-10">
                        <tr>
                            <th className="p-4 text-center border-2 border-blue-500">Student ID</th>
                            <th className="p-4 text-center border-2 border-blue-500">Name</th>
                            <th className="p-4 text-center border-2 border-blue-500">Year Level/Block</th>
                            <th className="p-4 text-center border-2 border-blue-500">Course</th>
                            <th className="p-4 text-center border-2 border-blue-500">Status</th>
                            <th className="p-4 text-center border-2 border-blue-500">Action</th>
                        </tr>
                    </thead>
