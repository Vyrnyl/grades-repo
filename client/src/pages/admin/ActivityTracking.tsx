...
const ActivityTracking = () => {
  ...
  return (
    <div className='bg-cya-100 h-[98%] flex flex-col flex-[80%] rounded-lg px-10 py-6 shadow-pageComponentShadow relative'>
      ...
      <h1 className="text-[1.7rem] font-semibold text-slate-800 self-center">LOGIN ATTEMPTS</h1>
      </div>
        ...
        <table className="w-full font-semibold text-white">
          <thead className="bg-blue-500 sticky top-0 z-10">
              <tr>
                  ...
                  <th className="px-4 py-4 text-center min-w-[5rem] border-r-2 border-blue-500">Status</th>
              </tr>
          </thead>
