    ...
    return (
        <PageContainer className='px-12'>
            <div className='flex-[.15] flex'>
                <h1 className='text-[2rem] font-medium text-slate-700 self-center'>Course Enrolled</h1>
            </div>
            <div className='font-[500] text-slate-700 flex gap-10 mt-2'>
                <div className='flex flex-col gap-2'>
                    <p>Student Name: {`${student.firstName.toUpperCase()}, ${student.lastName.toUpperCase()}`}</p>
